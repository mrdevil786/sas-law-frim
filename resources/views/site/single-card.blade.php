...
@section('website-page-title', '{{ $case->title }}')
                ...
                <div class="col-lg-12 posts-list">
                    <div class="single-post">
                        <div class="feature-img text-center">
                            <img class="img-fluid single-blog-img" src="{{ asset($case->image) }}" alt="">
                        </div>
                        <div class="blog_details">
                            <h2>{{ $case->title }}</h2>
                            <ul class="blog-info-link mt-3 mb-4">
                                <li><a href="#"><i class="fa fa-user"></i> {{ $case->author->name }}</a></li>
                                <li><a href="#"><i class="fa fa-calendar"></i>
                                        {{ $case->created_at->format('d M Y') }}</a></li>
                            </ul>
                            <div class="excert">{!! $case->description !!}</div>
                        </div>
                    </div>
